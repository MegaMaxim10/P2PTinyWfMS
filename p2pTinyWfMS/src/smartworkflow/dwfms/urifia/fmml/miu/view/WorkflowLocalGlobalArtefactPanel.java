...
public class WorkflowLocalGlobalArtefactPanel extends PanelModel {
	...
	public WorkflowLocalGlobalArtefactPanel(ControllerModel controller) {
        super(controller);
        updater = new Updater();
	...
	private void updateArtefact() {
		if(peerStatus != null && peerStatus.getGlobalArtefact() != null){
			this.mainPanel.removeAll();
			WorkflowDisplayArtefactPanel panel = new WorkflowDisplayArtefactPanel(controller, peerStatus.getGlobalArtefact());
	...
	private void initToolBar() {
        ...
        this.titleLabel.setText(ModelModel.getConfig().getLangValue("local_globale_artefact"));
