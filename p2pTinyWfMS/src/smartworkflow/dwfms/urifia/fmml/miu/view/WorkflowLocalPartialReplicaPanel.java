...
public class WorkflowLocalPartialReplicaPanel extends PanelModel {
	...
	public WorkflowLocalPartialReplicaPanel(ControllerModel controller) {
        super(controller);
        updater = new Updater();
	...
	private void updateArtefact() {
		if(peerStatus != null && peerStatus.getPartialReplica() != null){
			this.mainPanel.removeAll();
			WorkflowDisplayArtefactPanel panel = new WorkflowDisplayArtefactPanel(controller, peerStatus.getPartialReplica());
	...
	private void initToolBar() {
        ...
        this.titleLabel.setText(ModelModel.getConfig().getLangValue("local_partial_replica"));
        titleLabel.setFont(new Font("Cambria", Font.BOLD, 12));
        
        ImageIcon icon = new ImageIcon(getClass().getResource("/smartworkflow/dwfms/urifia/fmml/miu/resources/images/search_small.png"));
