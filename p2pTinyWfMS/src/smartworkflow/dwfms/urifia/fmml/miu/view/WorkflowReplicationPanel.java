...
public class WorkflowReplicationPanel extends PanelModel {
	...
	public WorkflowReplicationPanel(ControllerModel controller) {
        super(controller);
        updater = new Updater();
	...
	private void updateArtefact() {
		if(partialReplica != null){
			this.mainPanel.removeAll();
			WorkflowDisplayArtefactPanel panel = new WorkflowDisplayArtefactPanel(controller, partialReplica);
	...
	private void initToolBar() {
        ...
        this.titleLabel.setText(ModelModel.getConfig().getLangValue("after_replication"));
	...
	public class Updater extends ObserverAdapter{
		...
		public void updateReplicatedArtefact(
				PeerToPeerWorkflowArtefact replica) {
			partialReplica = replica;
			updateArtefact();
		}
	}
}
